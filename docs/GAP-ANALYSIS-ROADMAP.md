...
| E14 | Branch protection em `main` — regra de "humano sempre aprova" não tinha enforcement técnico nenhum | Crítico | Baixo | Merge sem review, sem CI passar, sem nada — mina E1-E13 na última milha | **P0** | ✅ Done — 1 aprovação + status check + enforce_admins, aplicado via API | [TWI-349](https://linear.app/twinfo-lifters/issue/TWI-349) | — |
